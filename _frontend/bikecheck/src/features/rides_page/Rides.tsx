...
export function Rides(): ReactElement {
  ...
  return (
    <Tabs
      value={activeTab}
      onChange={(value) => setTab(value === "pending" ? "pending" : "rides")}
    ...
    >
      <Tabs.List grow>
        <Tabs.Tab value="rides">{t("rides.tabRides")}</Tabs.Tab>
      ...
      <Tabs.Panel value="pending">
        <Box pt="sm">
          <PendingRides
            openActivityId={requestedActivityId}
            onOpenedActivityHandled={clearRequestedActivity}
          />
        </Box>
      </Tabs.Panel>
    </Tabs>
