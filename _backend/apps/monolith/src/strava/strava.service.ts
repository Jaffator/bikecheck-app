...
export class StravaEventsService {
  ...
  anaylyzeStravaData(data: any) {
    const splitObj = data.splits_metric as SplitsMetric;
    const riderWeight = await this.prisma.users.findUnique;
    const parameters = {
